        ...
        while global_episode_count <= int(self.max_episode_num):
            ...
            while not done:
                ...
                if done:
                    ...
                    # 에피소드마다 결과 보상값 출력
                    print('Worker name: ', self.worker_name, 'Episode: ', global_episode_count, 'Step: ', step,
